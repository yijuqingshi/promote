package com.ztdh.promote.utils;
...
public class SharePreferenceUtils {
    ...
    private static SharePreferenceUtils util;
    private static SharedPreferences sp;

    private SharePreferenceUtils(Context context, String name) {
    ...
    public static void getInstance(Context context, String name) {
        if (util == null) {
            util = new SharePreferenceUtils(context, name);
        }
    }
