package com.ztdh.promote.widget.bottombar;
...
//        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.tab_unselect));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.buttom_selected_color));
        } else {
            mIvIcon.setImageResource(mEntity.getTabUnselectedIcon());
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.buttom_normal_color));
        }
    }
